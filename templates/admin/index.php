...
<div class="container-fluid">
    ...
    <div class="row mt-4">
        ...
        <div class="col">
            ...
            <div class="d-flex ms-0 me-auto justify-content-around bg-body-tertiary shadow-lg rounded rounded-2 mb-5 p-2">
...
<div class="row mt-4 d-flex justify-content-between">
    ...
    <div class="col border border-1 border-danger"></div>
